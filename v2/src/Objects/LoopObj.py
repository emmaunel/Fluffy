import v2.src.Objects.ConditionObj
...
class LoopObj():
    ...
    def transpile(self):
        ...
        for val in self.ast:
            ...
            try:
                initValName = val['initialValueName']
            except:
                pass

            # Get the initialValue
            try:
                initVal = val['initialValue']
            except:
                pass
        ...
        self.exec_string += "for " + initValName + " in range(" + str(initVal) + ", " + str(
            endVal) + ", " + incrementer + "):\n"
    ...
    def transpile_body(self, body_ast, nesting_count):
        ...
        for ast in body_ast:
            ...
            if self.check_ast('ConditionalStatement', ast):
                ...
                #condition_obj = Objets(ast, nesting_count)
                condition_obj = v2.src.Objects.ConditionObj.Condition(ast, nesting_count)
            ...
            if self.check_ast('ForLoop', ast):
                ...
                if self.should_increment_nest_count(ast, self.ast):
                    nesting_count += 1
                # Create conditional statement exec string
                loop_obj = LoopObj(ast, nesting_count)
